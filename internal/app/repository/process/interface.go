...
type Repository interface {
	...
	ImportSystemTrx(ctx context.Context, data []*systems.SystemTrxData, from, to int) (err error)
	ImportBankTrx(ctx context.Context, data []*banks.BankTrxData, from, to int) (err error)
