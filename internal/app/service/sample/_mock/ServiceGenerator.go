...
import (
	...
	sample "github.com/oprekable/bank-reconcile/internal/app/service/sample"
)
...
func (_m *ServiceGenerator) GenerateSample(ctx context.Context, fs afero.Fs, bar *progressbar.ProgressBar, isDeleteDirectory bool) (sample.Summary, error) {
